...
MagicLens ships as **signed desktop installers**. Get the app from a **GitHub Release** — each version is a tag (`v0.1.26`, …). There is no source checkout and nothing to build.
