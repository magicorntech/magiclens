export const en = {
  ...
  chrome: {
    ...
    resizeSidebar: 'Resize cluster menu',
  ...
  settings: {
    ...
    appearance: {
      intro:
        'Light and dark each have their own palette. White and Black are the clean bases; Classic and Worlds tint the rest of the chrome.',
      modeTitle: 'Mode',
      modeHint: 'Light, dark, or match the system.',
      modeLight: 'Light',
      modeDark: 'Dark',
      modeSystem: 'System',
      colorTitle: 'Color',
      colorHint: 'Used in {{mode}} mode. Switch mode above to edit the other palette.',
      groupBase: 'Base',
      groupClassic: 'Classic',
      groupWorlds: 'Worlds — anime & heroes',
      lightThemes: 'Light theme',
      lightThemesHint: 'Used whenever the app is in light mode — pick White for a clean look, or a tinted preset.',
      darkThemes: 'Dark theme',
      darkThemesHint: 'Used whenever the app is in dark mode — pick Black for true black, or a tinted preset.',
      customAccent: 'Custom accent',
      customAccentLight: 'Custom light accent',
      customAccentDark: 'Custom dark accent',
      customAccentHint: 'Applies to sidebars, buttons, highlights, and chart accents for this mode.',
      customSwatch: 'Your own accent color',
      typographyTitle: 'Text',
      typographyHint: 'Typeface and readability. Color stays the same.',
      font: 'Font',
  ...
  pvcMetrics: {
    usage: 'Volume usage',
    unavailableTitle: 'PVC usage unavailable',
    queryFailed: 'Prometheus query failed',
    usedValue: 'Used {{value}}',
    usedUnknown: 'Used —',
    capacityValue: 'Capacity {{value}}',
    capacityUnknown: 'Capacity —',
    availableValue: 'Free {{value}}'
  },
  clusterOverview: {
  ...
  storageOverview: {
    ...
    fullest: 'Fullest claims',
    noUsage: 'No PVC usage metrics yet — Prometheus kubelet volume stats required',
    usageMeta: '{{percent}}% · {{used}} / {{capacity}}'
  },
  timeline: {
    eyebrow: 'Kubernetes events',
    title: 'Timeline',
    density: 'Density',
    now: 'Now',
    search: 'Search reason, message, resource…',
    allKinds: 'All kinds',
    chipAll: 'All',
    chipWarnings: 'Warnings',
    chipNormal: 'Normal',
    ...
    legendInstant: 'instant event',
    legendDuration: 'duration',
    showing: 'Showing {{shown}} of {{total}} events · {{resources}} resources · {{range}}',
    rangeWindow: 'last {{label}}',
    eventDensity: 'Event density',
    densityUnit: 'events / {{minutes}} min',
    ...
    collapse: 'Collapse',
    count: 'Count',
    timeout: 'Event list timed out. Pick a namespace — cluster-wide /api/v1/events is too heavy.',
    tipResource: 'resource',
    tipNamespace: 'namespace',
    tipFirstSeen: 'first seen',
    tipLastSeen: 'last seen',
    tipCount: 'count',
    resizeTree: 'Resize resource list'
  },
  crdBrowser: {
    brand: 'Custom Resources',
    browser: 'Browser',
    tabAll: 'All kinds',
    tabInstalled: 'Installed',
    kindCount: '{{count}} kinds',
    searchKinds: 'Search kinds…',
    emptyKinds: 'No custom resource kinds on this cluster',
    emptyInstalled: 'No CRDs with live instances',
    emptyFilter: 'No kinds match your filter',
    pickKind: 'Select a kind on the left to browse instances',
    emptyInstances: 'No live instances of this kind',
    colName: 'Name',
    colNamespace: 'Namespace',
    colAge: 'Age',
    colLabels: 'Labels',
  ...
  visualizer: {
    ...
    empty: 'No workloads or services to map.',
    error: 'Failed to load visualizer',
    graphCrash: 'The map failed to render. Try refreshing.',
    stats: '{{namespaces}} namespaces · {{workloads}} workloads · {{services}} services'
  },
  clustersHub: {
    brandEyebrow: 'MagicLens',
    title: 'Clusters',
  ...
  clusterSettings: {
    ...
    integrations: {
      title: 'Integrations',
      hint: 'Auto-detect Grafana, Prometheus, and Argo CD Services in the cluster. Set a URL here only to open them from outside.',
      urlHint: 'Leave blank to open via an in-cluster Service (port-forward). Fill this in to use your own URL instead.'
    },
    performance: {
      title: 'Performance',
  ...
  clusterApps: {
    ...
    opening: 'Looking for {{name}} in the cluster…',
    missingTitle: '{{name}} was not found',
    missingBody:
      'MagicLens looks for a matching Service in the cluster and opens it through a local port-forward. Credentials are read from a Secret when possible. If the Service is missing, add a URL below.',
    openSettings: 'Open cluster settings',
    retryDiscover: 'Scan again',
    saveAndOpen: 'Save and open',
    url: 'URL',
    urlPlaceholder: 'https://grafana.example.com',
    urlRequired: 'Add a URL to continue',
    user: 'user',
    password: 'password',
  ...
  helmEditor: {
    ...
    addRepo: 'Focus chart search',
    chartCount: '{{count}} charts',
    noCharts: 'No charts match this search',
    pickChart: 'Select a chart to inspect',
    ...
    install: 'Install',
    deploy: 'Deploy',
    deployed: 'Chart deployed',
    releaseName: 'Release name',
    namespace: 'Namespace',
    version: 'Version',
    searchReleases: 'Search releases',
    releaseCount: '{{count}} releases',
    noReleases: 'No Helm releases in this cluster',
    pickRelease: 'Select a release',
    delete: 'Delete',
    rollback: 'Rollback',
    deleteReleaseTitle: 'Delete {{name}}?',
    deleteReleaseBody: 'This uninstalls the release in {{namespace}} and removes its history.',
    deleted: 'Release uninstalled',
    noRollback: 'No previous revision to roll back to',
    rolledBack: 'Rolled back to revision {{revision}}',
    upgrade: 'Upgrade release',
    update: 'Update',
    updated: 'Release updated',
    noNotes: 'This revision has no notes',
    revision: 'revision {{n}}',
    colName: 'Name',
    colNamespace: 'Namespace',
    colKind: 'Kind',
    ...
    resizeList: 'Resize chart list',
    resizeInstall: 'Resize install panel'
  },
  clusterEdit: {
    title: 'Edit Cluster',
  ...
  resourceDetail: {
    ...
    workloadLogs: {
      ...
      following: 'Following',
      paused: 'Paused',
      pausedBanner: 'Log streaming paused',
      restart: 'Restart',
      filter: 'Filter logs',
      download: 'Download',
      saved: 'Logs saved to {{path}}',
      ended: 'Log stream ended',
      noPods: 'No pods found for this resource.',
      waiting: 'Waiting for log output from {{count}} streams…',
      unavailable: 'Log streaming is unavailable. Restart MagicLens.'
    },
    workloadPods: {
      empty: 'No pods found for this resource.',
