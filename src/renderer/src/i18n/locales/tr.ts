...
export const tr: TranslationOverrides = {
  ...
  chrome: {
    ...
    resizeSidebar: 'Küme menüsünü yeniden boyutlandır',
  ...
  settings: {
    ...
    appearance: {
      intro:
        'Açık ve koyu ayrı paletler. White ve Black sade tabanlar; Classic ve Worlds geri kalanı renklendirir.',
      modeTitle: 'Mod',
      modeHint: 'Açık, koyu veya sistemi takip et.',
      modeLight: 'Açık',
      modeDark: 'Koyu',
      modeSystem: 'Sistem',
      colorTitle: 'Renk',
      colorHint: '{{mode}} modunda kullanılır. Diğer paleti düzenlemek için yukarıdan mod değiştir.',
      groupBase: 'Taban',
      groupClassic: 'Klasik',
      groupWorlds: 'Dünyalar — anime & kahramanlar',
      lightThemes: 'Açık tema',
      lightThemesHint: 'Uygulama açık moddayken kullanılır — sade görünüm için White, renkli bir preset de seçebilirsin.',
      darkThemes: 'Koyu tema',
      darkThemesHint: 'Uygulama koyu moddayken kullanılır — tam siyah için Black, renkli bir preset de seçebilirsin.',
      customAccent: 'Özel vurgu',
      customAccentLight: 'Özel açık vurgu',
      customAccentDark: 'Özel koyu vurgu',
      customAccentHint: 'Bu moddaki kenar çubukları, düğmeler, vurgular ve grafik tonlarına uygulanır.',
      customSwatch: 'Kendi vurgu rengin',
      typographyTitle: 'Yazı',
      typographyHint: 'Font ve okunabilirlik. Renk teması aynı kalır.',
      font: 'Font',
      font_default: 'Varsayılan (Inter)',
      font_system: 'Sistem UI',
      ...
      previewPrimary: 'Ana renk',
      previewSidebar: 'Kenar çubuğu',
      previewBackground: 'Arka plan',
      activeCustomTheme: 'Aktif temanız: "{{name}}"',
      deleteCustomTheme: 'Sil',
      saveCustomTheme: 'Yeni tema olarak kaydet',
      saveCustomThemeHint: 'Bu rengi daha sonra tekrar seçebilmek için bir isim verin.',
      saveCustomThemePlaceholder: 'Tema adı',
      save: 'Kaydet'
    },
    sparks: {
  ...
  resourceNav: {
    ...
    virtual: {
      ...
      argoApplicationSets: 'App Sets',
      argoProjects: 'Projeler',
      argoRepositories: 'Repolar',
      argoClusters: 'Cluster’lar',
      appArgoCd: 'Web arayüzü',
      appPrometheus: 'Prometheus',
      appGrafana: 'Grafana',
      operatorResources: 'Özel kaynaklar',
      dynamicCustomResources: 'Özel kaynaklar',
      definitions: 'Tanımlar'
    },
    search: 'Menüde filtrele',
    favorites: 'Favoriler',
    ...
    aria: 'Kaynaklar',
    resize: 'Kaynak menüsünü yeniden boyutlandır',
    kinds: {
      Nodes: 'Nodes',
      ...
      ReplicationControllers: 'Replica Ctrls',
      Jobs: 'Jobs',
      CronJobs: 'CronJobs',
      ConfigMaps: 'ConfigMaps',
      Secrets: 'Secrets',
      ResourceQuotas: 'Kotalar',
      ...
      ValidatingAdmissionPolicies: 'Admission Policies',
  ...
  pvcMetrics: {
    usage: 'Volume kullanımı',
    unavailableTitle: 'PVC kullanımı yok',
    queryFailed: 'Prometheus sorgusu başarısız',
    usedValue: 'Kullanılan {{value}}',
    usedUnknown: 'Kullanılan —',
    capacityValue: 'Kapasite {{value}}',
    capacityUnknown: 'Kapasite —',
    availableValue: 'Boş {{value}}'
  },
  clusterOverview: {
  ...
  storageOverview: {
    ...
    fullest: 'En dolu claim’ler',
    noUsage: 'PVC kullanım metrikleri yok — Prometheus kubelet volume stats gerekir',
    usageMeta: '{{percent}}% · {{used}} / {{capacity}}'
  },
  timeline: {
    eyebrow: 'Kubernetes olayları',
    title: 'Timeline',
    density: 'Yoğunluk',
    now: 'Şimdi',
    search: 'Reason, mesaj, kaynak ara…',
    allKinds: 'Tüm kind’ler',
    chipAll: 'Tümü',
    chipWarnings: 'Uyarılar',
    chipNormal: 'Normal',
    chipResources: 'Kaynaklar',
    rangeLabel: 'Zaman aralığı',
    rangeAll: 'Tümü',
    legendNormal: 'normal',
    legendWarning: 'uyarı',
    legendSuccess: 'başarılı',
    legendInstant: 'anlık olay',
    legendDuration: 'süre',
    showing: '{{total}} olayın {{shown}} tanesi · {{resources}} kaynak · {{range}}',
    rangeWindow: 'son {{label}}',
    eventDensity: 'Olay yoğunluğu',
    densityUnit: 'olay / {{minutes}} dk',
    ...
    collapse: 'Daralt',
    count: 'Adet',
    timeout: 'Event listesi zaman aşımına uğradı. Bir namespace seç — tüm cluster event listesi çok ağır.',
    tipResource: 'resource',
    tipNamespace: 'namespace',
    tipFirstSeen: 'first seen',
    tipLastSeen: 'last seen',
    tipCount: 'count',
    resizeTree: 'Kaynak listesini boyutlandır'
  },
  crdBrowser: {
    brand: 'Özel kaynaklar',
    browser: 'Tarayıcı',
    tabAll: 'Tüm kind’ler',
    tabInstalled: 'Yüklü',
    kindCount: '{{count}} kind',
    searchKinds: 'Kind ara…',
    emptyKinds: 'Bu cluster’da custom resource kind yok',
    emptyInstalled: 'Canlı instance’ı olan CRD yok',
    emptyFilter: 'Filtreye uyan kind yok',
    pickKind: 'Instance’ları görmek için soldan bir kind seç',
    emptyInstances: 'Bu kind için canlı instance yok',
    colName: 'Ad',
  ...
  visualizer: {
    title: 'Visualizer',
    search: 'Kaynaklarda filtrele…',
    filter: 'Filtre',
    refresh: 'Yenile',
    loading: 'Harita oluşturuluyor…',
    empty: 'Haritalanacak iş yükü veya servis yok.',
    error: 'Visualizer yüklenemedi',
    graphCrash: 'Harita çizilemedi. Yenilemeyi deneyin.',
    stats: '{{namespaces}} namespace · {{workloads}} iş yükü · {{services}} servis'
  },
  resourceDetail: {
    tabs: {
      overview: 'Genel',
    ...
    workloadLogs: {
      allPods: 'Tüm pod’lar ({{count}})',
      allContainers: 'Tüm container’lar',
      following: 'Canlı',
      paused: 'Duraklatıldı',
      pausedBanner: 'Log akışı duraklatıldı',
      restart: 'Yeniden başlat',
      filter: 'Loglarda ara',
      download: 'İndir',
      saved: 'Loglar kaydedildi: {{path}}',
      ended: 'Log akışı bitti',
      noPods: 'Bu kaynak için pod bulunamadı.',
      waiting: '{{count}} akıştan log bekleniyor…',
      unavailable: 'Log akışı kullanılamıyor. MagicLens’i yeniden başlat.'
    },
    workloadPods: {
      empty: 'Bu kaynak için pod bulunamadı.',
  ...
  clusterSettings: {
    ...
    integrations: {
      ...
      hint: 'Grafana, Prometheus ve Argo CD Service’leri cluster içinde aranır. URL’yi yalnızca dışarıdan açmak istersen yaz.',
      urlHint: 'Boş bırakırsanız cluster içindeki Service port-forward ile açılır. Kendi URL’nizi yazarsanız o kullanılır.'
    },
    performance: {
      title: 'Performans',
  ...
  clusterApps: {
    ...
    opening: '{{name}} cluster’da aranıyor…',
    missingTitle: '{{name}} bulunamadı',
    missingBody:
      'MagicLens cluster’daki eşleşen Service’i arar ve yerel port-forward ile açar. Kullanıcı/şifre mümkünse Secret’tan okunur. Service yoksa URL’yi aşağıya yazın.',
    openSettings: 'Küme ayarlarını aç',
    retryDiscover: 'Tekrar tara',
    saveAndOpen: 'Kaydet ve aç',
    url: 'URL',
    urlPlaceholder: 'https://grafana.example.com',
    urlRequired: 'Devam etmek için bir URL yazın',
    user: 'user',
    password: 'password',
  ...
  helmEditor: {
    packageEditor: 'Paket editörü',
    charts: 'Chart’lar',
    releases: 'Release’ler',
    searchCharts: 'Chart ara',
    addRepo: 'Chart aramasına odaklan',
    chartCount: '{{count}} chart',
    noCharts: 'Bu aramayla eşleşen chart yok',
    pickChart: 'İncelemek için bir chart seçin',
    applicationChart: 'Uygulama chart’ı',
    yaml: 'YAML',
    versionLabel: 'Sürüm',
    nameHeader: 'Ad',
    copy: 'Kopyala',
    ...
    install: 'Kur',
    deploy: 'Deploy',
    deployed: 'Chart kuruldu',
    releaseName: 'Release adı',
    namespace: 'Namespace',
    version: 'Sürüm',
    searchReleases: 'Release ara',
    releaseCount: '{{count}} release',
    noReleases: 'Bu cluster’da Helm release yok',
    pickRelease: 'Bir release seçin',
    delete: 'Sil',
    rollback: 'Rollback',
    deleteReleaseTitle: '{{name}} silinsin mi?',
    deleteReleaseBody: '{{namespace}} içindeki release ve geçmişi kaldırılır.',
    deleted: 'Release kaldırıldı',
    noRollback: 'Geri alınacak önceki revision yok',
    rolledBack: 'Revision {{revision}} sürümüne dönüldü',
    upgrade: 'Release güncelle',
    update: 'Update',
    updated: 'Release güncellendi',
    noNotes: 'Bu revision’da not yok',
    revision: 'revision {{n}}',
    colName: 'Ad',
    colNamespace: 'Namespace',
    colKind: 'Kind',
    ...
    resizeList: 'Listeyi yeniden boyutlandır',
    resizeInstall: 'Kurulum panelini yeniden boyutlandır'
  },
  clusterEdit: {
