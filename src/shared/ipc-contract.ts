export const IPC = {
  ...
  NOTES_RENAME_FOLDER: 'notes:renameFolder',
  NOTES_DELETE_FOLDER: 'notes:deleteFolder',
  NOTES_SET_FOLDER_ICON: 'notes:setFolderIcon',
  NOTES_FOLDER_ICON_IMPORT: 'notes:folderIconImport',
  NOTES_FOLDER_ICON_FROM_DATA_URL: 'notes:folderIconFromDataUrl',
  NOTES_CANVAS_GET: 'notes:canvasGet',
  NOTES_CANVAS_SAVE: 'notes:canvasSave',
  NOTES_SKETCH_GET: 'notes:sketchGet',
  NOTES_SKETCH_SAVE: 'notes:sketchSave',
  NOTES_MEDIA_IMPORT: 'notes:mediaImport',
